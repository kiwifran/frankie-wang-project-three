    ...
    meat: [
        {
            ...
            picLink:"assets/recipe-pic/baconBolognese.jpg",
        ...
        },
        {
            ...
            author:"Good Food",
            picLink:"assets/recipe-pic/baconAndRoastOnionSalad.jpg",
        ...
        },
        {
            ...
            picLink:"assets/recipe-pic/lentilAndBaconSoup.jpg",
        ...
        },
        {
            ...
            author:"Good Food",
            picLink:"assets/recipe-pic/beefAndBeanHotpot.jpg",
        ...
        },
        {
            ...
            picLink:"assets/recipe-pic/beefBulgogiStir-fry.jpg",
        ...
        },
        {
            ...
            servingNumber:[3,"less"],
            author:"Cassie Best",
            picLink:"assets/recipe-pic/crispyChilliBeef.jpg",
        ...
        },
        {
            ...
            servingNumber:[4,"more"],
            author:"Cassie Best",
            picLink:"assets/recipe-pic/bangBangChickenAndVegetableNoodles.jpg",
        ...
        },
        {
            ...
            author:"Jennifer Joyce",
            picLink:"assets/recipe-pic/springVegetableBrothWithShreddedChicken.jpg",
        ...
        },
        {
            ...
            servingNumber:[4,"more"],
            author:"Good Food",
            picLink:"assets/recipe-pic/spinachBaconAndWhiteBeanSalad.jpg",
        ...
        },
        {
            ...
            servingNumber:[2,"less"],
            author:"Good Food",
            picLink:"assets/recipe-pic/smokyMapleDuckSalad.jpg",
        ...
        },
        {
            ...
            servingNumber:[3,"less"],
            author:"Miriam Nice",
            picLink:"assets/recipe-pic/easyLambHotpot.jpg",
        ...
        },
        {
            ...
            servingNumber:[2,"less"],
            author:"Lulu Grimes",
            picLink:"assets/recipe-pic/aubergineCurryWithLambCutlets.jpg",
        ...
        },
        {
            ...
            servingNumber:[4,"more"],
            author:"Tom Kerridge",
            picLink:"assets/recipe-pic/sausageButterBeanSimmerAndServe.jpg",
        ...
        },
        {
            ...
            servingNumber:[4,"more"],
            author:"Sara Buenfeld",
            picLink: "assets/recipe-pic/chunkyBologneseSoup.jpg",
    ...
    veggies: [
        {
            ...
            servingNumber: [3,"less"],
            author: "Miriam Nice",
            picLink:"assets/recipe-pic/roastMushroomGnocchi.jpg",
        ...
        },
        {
            ...
            servingNumber: [4,"more"],
            author: "Miriam Nice",
            picLink:"assets/recipe-pic/mushroomBrunch.jpg",
        ...
        },
        {
            ...
            servingNumber: [4,"more"],
            author: "Good Food",
            picLink:"assets/recipe-pic/mushroomsOnToast.jpg",
        ...
        },
        {
            ...
            servingNumber: [4,"more"],
            author: "unknown",
            picLink:"assets/recipe-pic/healthyPastaPrimavera.jpg",
        ...
        },
        {
            ...
            servingNumber: [4,"more"],
            author: "Good Food",
            picLink:"assets/recipe-pic/warmCauliflowerSalad.jpg",
        ...
        },
        {
            ...
            servingNumber: [2,"less"],
            author:"Jennifer Joyce",
            picLink:"assets/recipe-pic/hotSourAubergine.jpg",
        ...
        },
        {
            ...
            servingNumber: [2,"less"],
            author:"Sara Buenfeld",
            picLink: "assets/recipe-pic/aubergineGoulash.jpg",
        ...
        },
        {
            ...
            servingNumber: [8,"more"],
            author:"Roopa Gulati",
            picLink: "assets/recipe-pic/spicyCauliflower.jpg",
        ...
        },
        {
            ...
            picLink: "assets/recipe-pic/creamyCauliflowerAndBroccoliBake.jpg",
        ...
        },
        {
            ...
            picLink: "assets/recipe-pic/gingerSweetTofu.jpg",
        ...
        },
        {
            ...
            picLink: "assets/recipe-pic/spinachCourgetteLasagne.jpg",
        ...
        },
        {
            ...
            servingNumber: [2,"less"],
            author:"Miriam Nice",
            picLink: "assets/recipe-pic/courgetteFrittatas.jpg",
        ...
        },
        {
            ...
            picLink: "assets/recipe-pic/carrotSalad.jpg",
...
recipeApp.renderRecipes = (recipe)=>{
    ...
    const $recipeImgWrapper = $("<div class='imageWrapper'></div>");
    const $recipeImg = $(`<div class="recipeImage"><img src="${recipe.picLink}" alt="picture of ${recipe.name}"/></div>`)
    const $timeAndNumber = $(`<div class="info"><span class="numberInfo">Serves ${recipe.servingNumber[0]}</span><span class="timeInfo">Cooking time:${recipe.time[0]} minutes</span></div>`)
    $recipeImgWrapper.append($recipeImg,$timeAndNumber);
    const $cookingSteps = $("<div class='flexWrapper'>");
    ...
    for(let i = 0; i <recipe.method.length; i++) {
        ...
        if(recipe.method.length % 2 ===1 && i === recipe.method.length-1) {
            $cookingSteps.append(`<div class="cookingStepSpecial"><span class="methodOrder">${i + 1}</span><p>${step}</p></div>`); 
        }else {
            console.log(step);
            $cookingSteps.append(`<div class="cookingStep"><span class="methodOrder">${i + 1}</span><p>${step}</p></div>`); 
        }
        
    }
    const $recipeLink = $(`<div class='pageLink'>Read <a href="${recipe.pageLink}" target="_blank">full recipe</a> including complete ingredients list written by ${recipe.author} at <a href="https://www.bbcgoodfood.com/" target="_blank">BBC Good Food page</a></div>`)
    // item.method.forEach(step => {
    //     $cookingSteps.append(`<div class="result cookingStep"><p>${step}</p></div>`);
    // });
    $("#results").empty();
    $("#results").addClass("resultWrapper");
    $("#results").append($recipeName,$recipeImgWrapper, $cookingSteps, $recipeLink);
    $(".anotherTry").html("<button class='reset'>Another recipe</button>")
...
recipeApp.storeInput = ()=>{
    $("form").on("submit", function(e){
        e.preventDefault();
        const $ingredientPref = $("input[name='ingredientPref']:checked").val();
        const $numberPref = $("input[name='numberPref']:checked").val();
        const $timePref = $("input[name='timePref']:checked").val();
...
recipeApp.reset = ()=>{
    $(".anotherTry").on("click", "button.reset", function (){
        $("form").trigger("reset");
        ...
        setTimeout(function () {
            $("#results").empty();
            $("#results").toggleClass("resultWrapper");
            $(".anotherTry").empty();
        }, 300);
    })
}
